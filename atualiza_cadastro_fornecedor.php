...
if(isset($_POST['done'])){   
    ...
    $telefone1_retorno = $_POST['telefone1'];
    $telefone2_retorno = $_POST['telefone2'];
    $fax_retorno = $_POST['fax'];
    $email_retorno = $_POST['email'];
    $site_retorno = $_POST['site'];
    $observacoes_retorno = $_POST['observacoes'];

    

           $sql_update = mysql_query("update `cadastro_fornecedor` set nome='$nome_retorno',contato='$contato_retorno',telefone1='$telefone1_retorno',telefone2='$telefone2_retorno',fax='$fax_retorno',email='$email_retorno',site='$site_retorno',observacoes='$observacoes_retorno'  where id = $id_retorno") or die(mysql_error()); 
...
?>
   <a href="cadastro_fornecedor_update.php">voltar</a><br>
